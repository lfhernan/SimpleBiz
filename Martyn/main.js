...
const A_names = arr.filter
(
    (names) =>
    {
        return (names.name[0].toUpperCase) == 'A' || names.age >= 18;
    }
)
.map
(
    (names) =>
    {
        return names.name + " meets the conditions";
    }
)

// const sentence = A_names.map
// (
//     (names) =>
//     {
//         return names + " is cool";
//     }
// )
